            ...
            <div className="w-full h-[calc(100vh-56px)] bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${heroBg})` }}>
                <div className="w-full h-[calc(100vh-56px)] bg-gradient-to-t from-black/75 to-black/50">
                    <div className="w-11/12 h-full mx-auto flex flex-col justify-center relative">
                        <h1 className="text-left mb-6 text-3xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-[#269CE1] to-[#58D628]">Find movies and tv's, discover now.</h1>
                        ...
                        <a href="/search" className="bg-gradient-to-r from-[#269CE1] to-[#58D628] text-slate-100 font-bold w-max p-2 rounded-full hover:scale-105 text-lg font-bold">click here to search</a>
