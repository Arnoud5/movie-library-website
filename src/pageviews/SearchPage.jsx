    ...
    <div>
      <div className="w-11/12 h-full mx-auto flex flex-col justify-center relative pt-24 pb-14">
        ...
        <form onChange={() => updateSearch()} className="flex items-center w-full">
          <input id="querySearch" type="text" name="search " className="lg:text-xl lg:p-4 bg-slate-100 w-full rounded-l-full px-4 py-2 focus:outline-0 truncate" placeholder="Search movies, tv show, person and else" />
